...
#'
#' @description Takes one sample from population and resample from it.
#'
#' @details A function from Lab 9
#'
#' @param iter the number of iterations
#' @param x the original sample
#' @param fun the function to pull the statistic from
#' @param alpha the confidence interval
#' @param cx another statistic
#' @param ...  special argument that can take additional arguments
#' @return A histogram of BootStrap sample statistics
#' @export
#'
#' @examples
#' \dontrun{myboot2(x=sam,fun="mean", alpha=0.05)
#' }
